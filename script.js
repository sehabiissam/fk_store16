/**
 * FKstore16 | LUXURY STREETWEAR 2026
 * MAIN SCRIPT
 */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const STORAGE_KEY = 'fkstore16-theme';
...
if (Firewall.isAdmin()) {
  ...
  // 4. CART SYSTEM
  let cart = JSON.parse(localStorage.getItem("fkstore16_cart") || "[]");
  ...
  const saveCart = () => {
    localStorage.setItem("fkstore16_cart", JSON.stringify(cart));
  };
  ...
  // ============ WISHLIST SYSTEM ============
  let wishlist = JSON.parse(localStorage.getItem("fkstore16_wishlist") || "[]");

  const saveWishlist = () => {
    localStorage.setItem("fkstore16_wishlist", JSON.stringify(wishlist));
    ...
    grid.innerHTML = wishlist
      .map(
        ...
        <div class="product-card" data-id="${item.id}" data-name="${item.name}" data-price="${item.price || 0}" data-img="${item.img}">
          ...
          <div class="product-info">
            <div class="product-brand">${item.category || "FKstore16"}</div>
    ...
    container.innerHTML = `
      ...
      <div class="product-view-layout product-view">
        ...
        <div class="product-view-details">
          <div>
            <span class="product-view-brand">FKstore16</span>
          ...
          <div class="product-view-description">
            ...
            <div class="product-view-description-text">${product.description || "Premium quality streetwear essential from the FKstore16 collection. Built for those who refuse to stay in the shadows. Each piece is crafted with precision and designed for the future."}</div>
          </div>
